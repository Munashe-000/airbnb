...
const {
    ...
    return (
        <Controller disabled={isLoading} isOpen={loginController.isOpen} title="Sign Up" actionLabel="Confirm" 
        onClose={loginController.onClose} onSubmit={handleSubmit(onSubmit)} body={bodyContent} footer={footerContent} /> /*html and css for form*/
    );
};

export default LoginController; /* Model for register action */